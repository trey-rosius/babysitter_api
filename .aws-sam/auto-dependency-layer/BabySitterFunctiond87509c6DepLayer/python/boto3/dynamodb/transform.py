...
class DynamoDBHighLevelResource(object):
    def __init__(self, *args, **kwargs):
        ...
        # Apply handler that creates a copy of the users provided dynamodb
...
class TransformationInjector(object):
    """Injects the transformations into the users provided parameters."""
...
class ConditionExpressionTransformation(object):
    ...
    def __call__(self, value):
        ...
        # Use the users provided value if it is not a ConditonBase object.
        return value
