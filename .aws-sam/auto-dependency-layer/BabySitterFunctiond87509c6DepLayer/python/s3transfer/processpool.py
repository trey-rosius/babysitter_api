...
DownloadFileRequest = collections.namedtuple(
    'DownloadFileRequest', [
        ...
        'filename',       # The users-requested download location
        'extra_args',     # Extra arguments to provide to client calls
        'expected_size',  # The users-provided expected size of the download
    ]
)
...
GetObjectJob = collections.namedtuple(
    'GetObjectJob', [
        ...
        'filename',       # The users-requested download location. The worker
