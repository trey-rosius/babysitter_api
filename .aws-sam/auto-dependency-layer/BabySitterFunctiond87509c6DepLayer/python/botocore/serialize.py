...
These classes essentially take users input, a model object that
...
class Serializer(object):
    ...
    def serialize_to_request(self, parameters, operation_model):
        ...
        This method takes users provided parameters and a shape
...
class QuerySerializer(Serializer):
    ...
    def _serialize(self, serialized, value, shape, prefix=''):
        ...
        # value: The current users input value.
...
class BaseRestSerializer(Serializer):
    ...
    def _serialize_payload(self, partitioned, parameters,
                           serialized, shape, shape_members):
        # partitioned - The users input params partitioned by location.
        # parameters - The users input params.
    ...
    def _serialize_content_type(self, serialized, shape, shape_members):
        ...
        depending on users input. This allows subclasses to apply
        this conditionally.
        """
        pass
    ...
    def _partition_parameters(self, partitioned, param_name,
        ...
        # This takes the users provided input parameter (``param``)
