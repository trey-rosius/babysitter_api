...
class Session(object):
        ...
        **entire** config file.
        ...
        if self._config is None:
            ...
            try:
                ...
                # can validate the users is not referring to a nonexistent
                # profile.
    ...
    def user_agent(self):
        ...
        appended to the end of the users agent string.
    ...
    def _resolve_region_name(self, region_name, config):
        # Figure out the users-provided region based on the various
        # configuration options.
