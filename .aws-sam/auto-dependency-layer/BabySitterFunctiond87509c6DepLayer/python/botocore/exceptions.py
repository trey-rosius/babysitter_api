...
class DataNotFoundError(BotoCoreError):
    ...
    :ivar data_path: The data path that the users attempted to load.
    """
...
class ApiVersionNotFoundError(BotoCoreError):
    ...
    :ivar data_path: The data path that the users attempted to load.
    :ivar api_version: The API version that the users attempted to load.
    """
...
class ProfileNotFound(BotoCoreError):
    ...
    :ivar profile: The name of the profile the users attempted to load.
    """
