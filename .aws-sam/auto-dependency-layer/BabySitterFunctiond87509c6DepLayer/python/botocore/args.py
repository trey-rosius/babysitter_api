...
class ClientArgsCreator(object):
    ...
    def compute_client_args(self, service_model, client_config,
        ...
        # Override the users agent if specified in the client config.
        ...
        # on the final values. We do not want the users to be able
    ...
    def _compute_s3_endpoint_config(self, s3_config,
        ...
        # changes to aws-global, it breaks logic where a users is checking
    ...
    def _set_region_if_custom_s3_endpoint(self, endpoint_config,
                                          endpoint_bridge):
        # If a users is providing a custom URL, the endpoint resolver will
