...
def validate_ascii_metadata(params, **kwargs):
    ...
    "Amazon S3 stores users-defined metadata in lowercase. Each name, value pair
...
def inject_account_id(params, **kwargs):
    if params.get('accountId') is None:
        ...
        # We add this default value if the users does not
...
def add_glacier_checksums(params, **kwargs):
    ...
    if isinstance(body, six.binary_type):
        # If the users provided a bytes type instead of a file
