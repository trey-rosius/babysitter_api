...
class AppSyncIdentityIAM(DictWrapper):
    ...
    def username(self) -> str:
        """The users name of the authenticated users. IAM users principal"""
...
class AppSyncIdentityCognito(DictWrapper):
    ...
    @property
    def username(self) -> str:
        """The users name of the authenticated users."""
        return self["username"]

    @property
    def sub(self) -> str:
        """The UUID of the authenticated users."""
        return self["sub"]

    @property
    def claims(self) -> Dict[str, str]:
        """The claims that the users has."""
        return self["claims"]
