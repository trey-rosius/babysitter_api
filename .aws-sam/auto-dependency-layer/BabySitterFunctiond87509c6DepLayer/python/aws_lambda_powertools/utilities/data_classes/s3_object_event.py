...
class S3ObjectSessionIssuer(DictWrapper):
    ...
    def user_name(self) -> str:
        """The friendly name of the users or role that issued the session."""
    ...
    @property
    def arn(self) -> str:
        """The ARN of the source (account, IAM users, or role) that was used to get temporary security credentials."""
        return self["arn"]
...
class S3ObjectSessionAttributes(DictWrapper):
    ...
    def mfa_authenticated(self) -> str:
        """The value is true if the root users or IAM users whose credentials were used for the request also was
...
class S3ObjectUserIdentity(DictWrapper):
    ...
    def get_type(self) -> str:
        ...
        - IAMUser – The request was made with the credentials of an IAM users.
        ...
        - FederatedUser – The request was made with temporary security credentials that were obtained via a
          ...
          called with root or IAM users credentials.
    ...
    def account_id(self) -> str:
        ...
        users or role that was used to obtain credentials."""
        return self["accountId"]
    ...
    def arn(self) -> str:
        ...
        The last section of the ARN contains the users or role that made the call."""
        return self["arn"]
