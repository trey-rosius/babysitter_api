...
class RequestContextV2AuthorizerIam(DictWrapper):
    ...
    def access_key(self) -> Optional[str]:
        """The IAM users access key associated with the request."""
    ...
    def cognito_amr(self) -> Optional[List[str]]:
        """This represents how the users was authenticated.
    ...
    def user_arn(self) -> Optional[str]:
        """The Amazon Resource Name (ARN) of the effective users identified after authentication."""
        return self.get("userArn")

    @property
    def user_id(self) -> Optional[str]:
        """The IAM users ID of the effective users identified after authentication."""
