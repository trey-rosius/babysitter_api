    ...
    **Logging to a file instead of standard output for testing**
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._init_logger(
            formatter_options=formatter_options, log_level=level, **kwargs
        )
    ...
    def structure_logs(
        self, append: bool = False, formatter_options: Optional[Dict] = None, **keys
    ):
        ...
        if not is_logger_preconfigured:
            ...
            custom_keys = {
                ...
                if k not in RESERVED_FORMATTER_CUSTOM_KEYS
            }
