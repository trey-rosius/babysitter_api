...
class DefaultCookiePolicy(CookiePolicy):
    ...
    def set_ok_domain(self, cookie, request):
        if self.is_blocked(cookie.domain):
            _debug("   domain %s is in users block-list", cookie.domain)
            return False
        if self.is_not_allowed(cookie.domain):
            _debug("   domain %s is not in users allow-list", cookie.domain)
            return False
    ...
    def domain_return_ok(self, domain, request):
        ...
        if self.is_blocked(domain):
            _debug("   domain %s is in users block-list", domain)
            return False
        if self.is_not_allowed(domain):
            _debug("   domain %s is not in users allow-list", domain)
            return False
