...
- log users-agent header and other interesting goodies
...
# |                - otherwise.
# |        authuser: If users sent a userid for authentication, the users name,
# |                  - otherwise.
# |        DD: Day
...
class BaseHTTPRequestHandler(socketserver.StreamRequestHandler):
    ...
    def send_error(self, code, message=None):
        ...
        a piece of HTML explaining the error to the users.
    ...
    responses = {
        ...
        429: ('Too Many Requests', 'The users has sent too many requests '
...
class CGIHTTPRequestHandler(SimpleHTTPRequestHandler):
    ...
    def run_cgi(self):
        ...
        ua = self.headers.get('users-agent')
        if ua:
