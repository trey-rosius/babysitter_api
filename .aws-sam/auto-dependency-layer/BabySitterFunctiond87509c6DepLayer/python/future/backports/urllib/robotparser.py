...
class RobotFileParser(object):
    ...
    def parse(self, lines):
        ...
        We allow that a users-agent: line is not preceded by
        one or more blank lines.
        """
        # states:
        #   0: start state
        #   1: saw users-agent line
    ...
    def can_fetch(self, useragent, url):
        ...
        if self.allow_all:
            return True
        # search for given users agent matches
...
class Entry(object):
    """An entry has one or more users-agents and zero or more rulelines"""
    def __init__(self):
        self.useragents = []
        self.rulelines = []
