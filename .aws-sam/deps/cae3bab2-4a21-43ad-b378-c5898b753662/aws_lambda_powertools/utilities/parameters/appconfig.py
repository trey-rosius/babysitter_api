    ...
    **Retrieves a configuration value from App Config in another AWS region**
    ...
    def __init__(
        ...
        self._next_token: Dict[
            str, str
        ] = {}  # nosec - token for get_latest_configuration executions
    ...
    def _get(self, name: str, **sdk_options) -> str:
        ...
        if name not in self._next_token:
            ...
            response_configuration = self.client.start_configuration_session(
                **sdk_options
            )
        ...
        response = self.client.get_latest_configuration(
            ConfigurationToken=self._next_token[name]
        )
