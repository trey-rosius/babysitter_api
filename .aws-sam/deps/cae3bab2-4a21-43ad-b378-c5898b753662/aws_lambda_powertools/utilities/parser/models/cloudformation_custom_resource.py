...
class CloudFormationCustomResourceBaseModel(BaseModel):
    ...
    resource_properties: Union[Dict[str, Any], BaseModel, None] = Field(
...
class CloudFormationCustomResourceUpdateModel(CloudFormationCustomResourceBaseModel):
    ...
    old_resource_properties: Union[Dict[str, Any], BaseModel, None] = Field(
        None, alias="OldResourceProperties"
    )
