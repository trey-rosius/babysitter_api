            ...
            TransactItems=[
                {
                    "Put": {
                        "Item": {
                            ...
                            "GSI2PK": {"S": f'USER#{item["username"]}'},
                            "GSI2SK": {"S": f'USER#{item["username"]}'},
                            "id": {"S": item["id"]},
                            ...
                            "day": {"N": f"{item['day']}"},
                            "month": {"N": f"{item['month']}"},
                            "year": {"N": f"{item['year']}"},
                            "age": {"N": f"{item['age']}"},
                            "male": {"BOOL": item["male"]},
                            "female": {"BOOL": item["female"]},
                            "dateOfBirth": {"S": item["dateOfBirth"]},
                            "profilePicUrl": {"S": item["profilePicUrl"]},
                            "address": {"S": item["address"]},
                            "about": {"S": item["about"]},
                            "longitude": {"N": f"{item['longitude']}"},
                            "latitude": {"N": f"{item['latitude']}"},
